---
name: skill-domain-driven-design
...
| Phase | Playbook |
| :--- | :--- |
| **Strategic Discovery** | [create-user-stories.toml](./references/create-user-stories.toml) |
| **Logical Mapping** | [logical.toml](./references/logical.toml) |
| **Physical Design** | [physical.toml](./references/physical.toml) |
| **Execution Planning** | [plan.toml](./references/plan.toml) |
| **TDD Implementation** | [implement.toml](./references/implement.toml) |
| **Code Review** | [review.toml](./references/review.toml) |
| **Fixing & Regression** | [fix.toml](./references/fix.toml) |
...
Upon activation, list the playbooks to ensure all workflow steps are available:
`ls ./references/*.toml`