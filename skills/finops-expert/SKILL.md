...
| **Quota Management** | [quota-guide.md](./references/quota-guide.md) |
| **Governance Policies** | [policy-guide.md](./references/policy-guide.md) |

## Knowledge Bootstrap
1. Analyze resource usage vs costs.
2. Research `cost-optimization.md`.
3. Propose rightsizing or commitment plans.
