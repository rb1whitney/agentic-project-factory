---
name: aws-foundation-expert
description: Holistic AWS Foundation Expert. Deep expertise in Compute (EC2), Identity (IAM), Networking (VPC), and Databases (RDS). Orchestrates core service protocols via the Knowledge Bootstrap protocol.
related_skills: ["@aws-serverless-expert", "@aws-sagemaker-expert", "@cloud-debugger"]
