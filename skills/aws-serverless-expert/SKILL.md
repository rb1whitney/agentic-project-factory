---
name: aws-serverless-expert
description: Deep expertise in AWS Serverless (Lambda, SNS, SQS, API Gateway) with integrated SRE troubleshooting guides.
related_skills: ["@aws-iam-expert", "@cloud-debugger"]
