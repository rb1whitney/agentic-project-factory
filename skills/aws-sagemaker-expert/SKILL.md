---
name: aws-sagemaker-expert
description: Holistic AWS SageMaker AI Expert. Use for model fine-tuning (SFT, DPO, RLVR), HyperPod cluster management, dataset evaluation, and automated deployment. Orchestrates specific sub-skills via the Knowledge Bootstrap protocol.
related_skills: ["@aws-foundation-expert", "@cloud-debugger"]
