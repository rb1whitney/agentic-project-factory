...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 bin/memory_agent.py [init | start <session_id> | complete <session_id> | add-interaction <session_id> <req> <res> [tokens] | add-insight <session_id> <cat> <text> [score] | query <str> | summary]")
        sys.exit(1)
